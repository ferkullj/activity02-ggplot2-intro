...
**Response**: these were the same boxplots as before, but they are now filled with color and there is a legend that gives
each species their own color
...
**Response**: -boxplots are better for looking at the distribution of measurements and identifying outliers and centers
-jitterplots may be helpful in determining general counts of variables and to see where most observations are in the range
...
**Response**: The .md file is way easier to read and looks more professional
...
**Response**: I preferred the jitterplot layed over the boxplot because the other way around caused the boxplot
to 'block'/be on top of some of the jitters
...
**Response**: Having things mapped in the ggplot call seems to change all of the geoms_
If I wanted to change a geom_ specifically, I would change just that layer
